    ...
    render () {
      ...
      return (
        <div id="horizontal-chart">
          <VictoryChart theme={VictoryTheme.material} height={80} width={this.props.mapWidth} padding={{top: 10, left: 0, bottom: 0, right: 0}} containerComponent={<VictoryContainer responsive={false}/>}>
