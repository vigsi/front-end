...
export class DataSourceService {
    ...
    sources = [
        ...
        { id: "arimadaily", name: "ARIMA (Daily)", unit: "kJ/m²", color: "#aa2e25", type: "ss3", url: "https://vigsi-data-store.s3.us-east-2.amazonaws.com/arimadaily/", duration: Duration.fromObject({ days: 1 }), desc: "ARIMA predicted data generated from hourly measurements, the aggregated by integrating the step-wise hourly measured data function. Data prior to 2013 is in-sample; data from 2013 is out-of-sample. No data is available for 2007."},
        { id: "arimamonthly", name: "ARIMA (Monthly)", unit: "kJ/m²", color: "#aa2e25", type: "ss3", url: "https://vigsi-data-store.s3.us-east-2.amazonaws.com/arimamonthly/", duration: Duration.fromObject({ months: 1 }), desc: "ARIMA predicted data generated from hourly measurements, the aggregated by integrating the step-wise hourly measured data function. Data prior to 2013 is in-sample; data from 2013 is out-of-sample. No data is available for 2007."},
        { id: "arimayearly", name: "ARIMA (Yearly)", unit: "kJ/m²", color: "#aa2e25", type: "ss3", url: "https://vigsi-data-store.s3.us-east-2.amazonaws.com/arimayearly/", duration: Duration.fromObject({ years: 1 }), desc: "ARIMA predicted data generated from hourly measurements, the aggregated by integrating the step-wise hourly measured data function. Data prior to 2013 is in-sample; data from 2013 is out-of-sample. No data is available for 2007."},
        { id: "nnmonthly", name: "NN (Monthly)", unit: "kJ/m²", color: "#aa2e25", type: "ss3", url: "https://vigsi-data-store.s3.us-east-2.amazonaws.com/nnmonthly/", duration: Duration.fromObject({ months: 1 }), desc: "ARIMA predicted data generated from hourly measurements, the aggregated by integrating the step-wise hourly measured data function."},
    ];
